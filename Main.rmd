...
tictoc::tic()
set.seed(1856)
cadena1_M1 <- MCMC_1(X,y,B = 10000)
tictoc::toc()

# Gr·fico
yrange <- range(cadena1_M1$LP)
plot(cadena1_M1$LP, type = "p", pch = 20, cex = 0.8, col = "darkblue", ylim = yrange, xlab = "IteraciÛn",ylab = "Log-verosimilitud", main = "Modelo 1")
```
